...
class Staff extends Component {
    ...
    async onDelete(_id) {
        await axios.delete(`https://hostel-manage91.herokuapp.com/api/staff/${_id}`).then(res => console.log(res)).catch(err => console.log(err));
        await this.props.getStaffDetails();
    }
    async onAvailabilityChange(_id, isAvailable) {
        await axios.put(`https://hostel-manage91.herokuapp.com/api/staff/availability/${_id}`, { isAvailable: !isAvailable }).then(res => console.log(res)).catch(err => console.log(err));
        await this.props.getStaffDetails();
    }
    async onSubmit(e) {
        e.preventDefault();
