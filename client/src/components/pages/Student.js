...
class Student extends Component {
    ...
    async onDelete(id) {
        await axios.delete(`https://hostel-manage91.herokuapp.com/api/student`, { data: { id } }).then(res => console.log(res)).catch(err => console.log(err));
        await this.onFtechDetails();
    }
    async onStatusChange(id, isAvailable) {
        await axios.put(`https://hostel-manage91.herokuapp.com/api/student/availability`, { id, isAvailable: !isAvailable }).then(res => console.log(res)).catch(err => console.log(err));
        await this.onFtechDetails();
    }
    async onFtechDetails() {
        this.setState({ loading: true });
        if (this.state.findBy === 'id') {
            await axios.get(`https://hostel-manage91.herokuapp.com/api/student/id/${this.state.val}`).then((res) => {
            ...
            await axios.get(`https://hostel-manage91.herokuapp.com/api/student/room/${this.state.val}`).then((res) => {
                this.setState({ data: res, loading: false });
                console.log(res);
                if (!res.data.length) {
                    alert("Not Found");
            ...
            await axios.get(`https://hostel-manage91.herokuapp.com/api/student/all`).then((res) => {
